...
% newRelease
%   Prepares a new release of the scoGEM model, for direct submission to
%   GitHub.
%
...
%Bump version number:
oldModel   = load('../ModelFiles/mat/scoGEM.mat');
...
fclose(fid);
if ~contains(history,['scoGEM' newVersion ':'])
...
%Save model
exportForGit(model,'scoGEM','..',{'mat', 'txt', 'xlsx', 'xml', 'yml'});
