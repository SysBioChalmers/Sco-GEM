...
class RateEstimator(object):
    ...
    def plot_exponential_fit_CO2(self):
        ...
        ax.legend()
        ax.xlabel("Time after inoculation [h]")
        ax.ylabel("CO2 [mmol/L/h]")
        plt.show()
    ...
    def fit_substrate(self, substrate_name, phase_name = None, phase_limits = None):
        ...
        phases_dict[phase_name] = {"time": time_arr, "fit": fit, "popt": popt}
    ...
    def predict_uptake_rates(self, substrate, phase_name, timepoints, cdw_phase_name = None):
        ...
        for t, x in zip(timepoints, cdw_values):
            rate_dic[t] = 1e3 * dic["popt"][0] / x / MOLAR_MASS_DICT[substrate]
    ...
    def plot_uptake_fit(self, substrate):
        ...
        ax.legend()
        ax.xlabel("Time after inoculation [h]")
        ax.ylabel("{0} [g/L]".format(substrate))
        plt.show()
...
if __name__ == '__main__':
    if 0:
        ...
        RE.rates_as_df()
        RE.rates_as_df(save_name = "M1145_estimated_rates.csv")
    ...
    if 1:
        ...
        RE.rates_as_df(save_name = "M1152_estimated_rates.csv")
