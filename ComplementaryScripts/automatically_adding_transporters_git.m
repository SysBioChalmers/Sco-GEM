...
Table1=load('https://github.com/SysBioChalmers/Sco-GEM/tree/fix/transporters/ComplementaryData/curation/Table1_updated_grRules_280119_300119_6.csv');
Table1=readtable('Table1_updated_grRules_280119_300119_6.csv', 'ReadRowNames', false);
Table1=table2cell(Table1);
Table2=load('https://github.com/SysBioChalmers/Sco-GEM/tree/fix/transporters/ComplementaryData/curation/Table2_newTransportRxns_280119_300119_3.csv');
Table2=readtable('Table2_newTransportRxns_280119_300119_3.csv', 'ReadRowNames', false);
Table2=table2cell(Table2);
Table3=load('https://github.com/SysBioChalmers/Sco-GEM/tree/fix/transporters/ComplementaryData/curation/Table3_newTransportRxns_newMetabolites_280119_300119_3.csv');
Table3=readtable('Table3_newTransportRxns_newMetabolites_280119_300119_3.csv', 'ReadRowNames', false);
Table3=table2cell(Table3);
Table4=load('https://github.com/SysBioChalmers/Sco-GEM/tree/fix/transporters/ComplementaryData/curation/ExRxns_added_Transporters_300119_3.csv');
Table4=readtable('ExRxns_added_Transporters_300119_3.csv', 'ReadRowNames', false);
Table4=table2cell(Table4);
Table5=load('https://github.com/SysBioChalmers/Sco-GEM/tree/fix/transporters/ComplementaryData/curation/Sink_Rxns_scoGEM_Transporters_300119_3.csv');
Table5=readtable('Sink_Rxns_scoGEM_Transporters_300119_3.csv', 'ReadRowNames', false);
