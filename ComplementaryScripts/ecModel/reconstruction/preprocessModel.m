...
model = changeGeneAssoc(model, 'KAS15','(SCO1271 or SCO2388 or SCO6564 or SCO3246 or SCO6826 or SCP1233B) and (SCO2389 or SCO0549 or SCO1267 or SCO1272)');
model = changeGeneAssoc(model, 'MMM','(SCO4800 or SCO6833) and (SCO4869 or SCO6832 or SCO4515)');
model = changeGeneAssoc(model, 'SUCD9','(SCO0922 or SCO4855 or SCO5106) and (SCO0923 or SCO4856 or SCO5107 or SCO7109)');
